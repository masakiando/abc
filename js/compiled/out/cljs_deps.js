...
goog.addDependency("../integrant/core.js", ['integrant.core'], ['cljs.core', 'clojure.set', 'clojure.string', 'cljs.spec.alpha', 'clojure.walk', 'com.stuartsierra.dependency']);
goog.addDependency("../ar_sample/renderer.js", ['ar_sample.renderer'], ['cljs.core', 'integrant.core']);
goog.addDependency("../ar_sample/source.js", ['ar_sample.source'], ['cljs.core', 'integrant.core']);
goog.addDependency("../ar_sample/camera.js", ['ar_sample.camera'], ['cljs.core', 'integrant.core']);
goog.addDependency("../ar_sample/context.js", ['ar_sample.context'], ['cljs.core', 'ar_sample.source', 'ar_sample.camera', 'integrant.core']);
goog.addDependency("../ar_sample/app_state.js", ['ar_sample.app_state'], ['cljs.core', 'integrant.core']);
goog.addDependency("../ar_sample/clock.js", ['ar_sample.clock'], ['goog.string', 'cljs.core', 'goog.string.format', 'integrant.core']);
goog.addDependency("../ar_sample/mesh.js", ['ar_sample.mesh'], ['cljs.core', 'integrant.core']);
goog.addDependency("../ar_sample/marker.js", ['ar_sample.marker'], ['ar_sample.context', 'cljs.core', 'ar_sample.clock', 'ar_sample.mesh', 'integrant.core']);
goog.addDependency("../ar_sample/light.js", ['ar_sample.light'], ['cljs.core', 'integrant.core']);
goog.addDependency("../ar_sample/scene.js", ['ar_sample.scene'], ['ar_sample.marker', 'cljs.core', 'ar_sample.light', 'ar_sample.camera', 'integrant.core']);
goog.addDependency("../ar_sample/app.js", ['ar_sample.app'], ['goog.dom', 'ar_sample.renderer', 'ar_sample.context', 'ar_sample.app_state', 'cljs.core', 'ar_sample.source', 'ar_sample.scene', 'goog.events', 'ar_sample.camera', 'integrant.core']);
goog.addDependency("../ar_sample/core.js", ['ar_sample.core'], ['ar_sample.app', 'cljs.core', 'goog.events', 'integrant.core']);
...
goog.addDependency("../figwheel/connect/build_dev.js", ['figwheel.connect.build_dev'], ['cljs.core', 'ar_sample.core', 'figwheel.client', 'figwheel.client.utils']);
