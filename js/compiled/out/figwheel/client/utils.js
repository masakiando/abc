...
var or__30102__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj37711 = {"detail":data};
return obj37711;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30090__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30090__auto__)){
var and__30090__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__37718 = cljs.core._EQ_;
var expr__37719 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37718.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37719))){
return ((function (pred__37718,expr__37719){
return (function (p1__37712_SHARP_){
return console.warn(p1__37712_SHARP_);
});
;})(pred__37718,expr__37719))
} else {
if(cljs.core.truth_(pred__37718.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37719))){
return ((function (pred__37718,expr__37719){
return (function (p1__37713_SHARP_){
return console.debug(p1__37713_SHARP_);
});
;})(pred__37718,expr__37719))
} else {
if(cljs.core.truth_(pred__37718.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37719))){
return ((function (pred__37718,expr__37719){
return (function (p1__37714_SHARP_){
return console.error(p1__37714_SHARP_);
});
;})(pred__37718,expr__37719))
} else {
return ((function (pred__37718,expr__37719){
return (function (p1__37715_SHARP_){
return console.log(p1__37715_SHARP_);
});
;})(pred__37718,expr__37719))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37722){
...
var eval_fn = cljs.core.get.call(null,map__37723__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37725_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37727,(0),null);
var v = cljs.core.nth.call(null,vec__37727,(1),null);
...
if(cljs.core.truth_((function (){var and__30090__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1518288637422
