...
var len__31381__auto___40338 = arguments.length;
var i__31382__auto___40339 = (0);
while(true){
if((i__31382__auto___40339 < len__31381__auto___40338)){
args__31388__auto__.push((arguments[i__31382__auto___40339]));

var G__40340 = (i__31382__auto___40339 + (1));
i__31382__auto___40339 = G__40340;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31389__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq40336){
var G__40337 = cljs.core.first.call(null,seq40336);
var seq40336__$1 = cljs.core.next.call(null,seq40336);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__40337,seq40336__$1);
});
...
return (p1__40341_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1518288640183
