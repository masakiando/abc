...
var len__31381__auto___40347 = arguments.length;
var i__31382__auto___40348 = (0);
while(true){
if((i__31382__auto___40348 < len__31381__auto___40347)){
args__31388__auto__.push((arguments[i__31382__auto___40348]));

var G__40349 = (i__31382__auto___40348 + (1));
i__31382__auto___40348 = G__40349;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31389__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40344){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40345,G__40346,seq40344__$2);
});
...
if(cljs.core.truth_((function (){var or__30102__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__30773__auto__,writer__30774__auto__,opt__30775__auto__){
return cljs.core._write.call(null,writer__30774__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__30090__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__30090__auto__){
var or__30102__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__30102__auto__)){
return or__30102__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40350_SHARP_){
return !((cljs.core.meta.call(null,p1__40350_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__40351__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__30102__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e40355){var _e__39304__auto__ = e40355;
return false;
}})();
if(cljs.core.truth_(or__30102__auto__)){
return or__30102__auto__;
...
}catch (e40357){var _e__39304__auto__ = e40357;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40359 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40360 = opts;
...
var markup_db = cljs.core.get.call(null,map__40360__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40359;
}});
...
;
var temp__5455__auto___40364 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___40364)){
var managed_print_level_40365 = temp__5455__auto___40364;
var _STAR_print_level_STAR_40363_40366 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40365;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40363_40366,managed_print_level_40365,temp__5455__auto___40364,writer,opts,job_fn){
return (function (p1__40362_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40362_SHARP_,null);
});})(_STAR_print_level_STAR_40363_40366,managed_print_level_40365,temp__5455__auto___40364,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40363_40366;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1518288640381
