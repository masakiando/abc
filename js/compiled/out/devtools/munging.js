...
var o40216 = temp__5455__auto__;
var temp__5455__auto____$1 = (o40216["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o40217 = temp__5455__auto____$1;
return (o40217["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39297__auto__ = f;
return (o__39297__auto__["toString"]).call(o__39297__auto__);
} else {
return "";
}
...
try{var o__39297__auto___40220 = t;
(o__39297__auto___40220["cljs$lang$ctorPrWriter"]).call(o__39297__auto___40220,t,writer);
}catch (e40219){var __40221 = e40219;
}
...
var char_code = (function (){var o__39297__auto__ = (new String(char$));
return (o__39297__auto__["charCodeAt"]).call(o__39297__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39297__auto__ = String;
return (o__39297__auto__["fromCharCode"]).call(o__39297__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40222 = num_code;
switch (G__40222) {
case (1):
return (185);
...
var o__39297__auto__ = String;
return (o__39297__auto__["fromCharCode"]).call(o__39297__auto__,superscript_code);
});
/**
...
}catch (e40224){var _e__39304__auto__ = e40224;
return false;
}})())){
...
var vec__40225 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40225,(0),null);
...
var or__30102__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
if(cljs.core.truth_(temp__5455__auto__)){
var o40228 = temp__5455__auto__;
var temp__5455__auto____$1 = (o40228["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o40229 = temp__5455__auto____$1;
return (o40229["nameToPath"]);
} else {
return null;
}
} else {
...
var len__31381__auto___40236 = arguments.length;
var i__31382__auto___40237 = (0);
while(true){
if((i__31382__auto___40237 < len__31381__auto___40236)){
args__31388__auto__.push((arguments[i__31382__auto___40237]));

var G__40238 = (i__31382__auto___40237 + (1));
i__31382__auto___40237 = G__40238;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31389__auto__);
});
...
var ns_detector = cljs.core.nth.call(null,vec__40233,(0),null);
var effective_detector = (function (){var or__30102__auto__ = ns_detector;
if(cljs.core.truth_(or__30102__auto__)){
return or__30102__auto__;
} else {
...
var G__40239 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40240 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40239;
remaining_tokens = G__40240;
continue;
}
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__40231,seq40230__$1);
});
...
var vec__40244 = cljs.core.split_with.call(null,(function (p1__40243_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40243_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40244,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40244,(1),null);
...
var vec__40247 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40247,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40247,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40250 = cljs.core.rest.call(null,remaining_tokens);
var G__40251 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40250;
name_tokens = G__40251;
continue;
} else {
...
var vec__40254 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40254,(0),null);
var arity = cljs.core.nth.call(null,vec__40254,(1),null);
var vec__40257 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40257,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40257,(1),null);
var vec__40260 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40260,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40260,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40260,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40260,(3),null);
...
var vec__40266 = result;
var munged_ns = cljs.core.nth.call(null,vec__40266,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40266,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40266,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40266,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40266,(4),null);
var arity = cljs.core.nth.call(null,vec__40266,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__40270 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__40270,(0),null);
var args = cljs.core.nth.call(null,vec__40270,(1),null);
var vec__40273 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40273,(0),null);
var name = cljs.core.nth.call(null,vec__40273,(1),null);
...
var G__40276 = (arity + (1));
var G__40277 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40278){
var vec__40279 = p__40278;
var arity = cljs.core.nth.call(null,vec__40279,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40279,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__30102__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__30102__auto__)){
return or__30102__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__40282_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40283_SHARP_);
...
var args__31388__auto__ = [];
var len__31381__auto___40290 = arguments.length;
var i__31382__auto___40291 = (0);
while(true){
if((i__31382__auto___40291 < len__31381__auto___40290)){
args__31388__auto__.push((arguments[i__31382__auto___40291]));

var G__40292 = (i__31382__auto___40291 + (1));
i__31382__auto___40291 = G__40292;
continue;
} else {
}
break;
...
var argseq__31389__auto__ = ((((1) < args__31388__auto__.length))?(new cljs.core.IndexedSeq(args__31388__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31389__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40286){
var vec__40287 = p__40286;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40287,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40284){
var G__40285 = cljs.core.first.call(null,seq40284);
var seq40284__$1 = cljs.core.next.call(null,seq40284);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__40285,seq40284__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__30102__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__30102__auto__)){
return or__30102__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__30090__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__30102__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__30102__auto__)){
return or__30102__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__40295__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40295__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40295__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40295__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40296 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40296,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40296,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40296,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40296,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40296,(4),null);
var arity = cljs.core.nth.call(null,vec__40296,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__30090__auto__ = protocol_ns;
if(cljs.core.truth_(and__30090__auto__)){
return cljs.core.not.call(null,(function (){var and__30090__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__30102__auto__ = protocol_part;
if(cljs.core.truth_(or__30102__auto__)){
return or__30102__auto__;
} else {
return fn_part;
...
var o__39297__auto__ = f;
return (o__39297__auto__["getBasis"]).call(o__39297__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__30090__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30090__auto__)){
...
}catch (e40300){var _e__39304__auto__ = e40300;
...
var G__40301 = (obj[cljs.core.first.call(null,path)]);
var G__40302 = cljs.core.rest.call(null,path);
obj = G__40301;
path = G__40302;
continue;
} else {
...
var partition_bits = (function (){var or__30102__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__30102__auto__)){
return or__30102__auto__;
} else {
return (0);
...
return (function (accum,p__40303){
var vec__40304 = p__40303;
var bit = cljs.core.nth.call(null,vec__40304,(0),null);
var protocol = cljs.core.nth.call(null,vec__40304,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40307){
var vec__40308 = p__40307;
var ns = cljs.core.nth.call(null,vec__40308,(0),null);
var name = cljs.core.nth.call(null,vec__40308,(1),null);
var selector = cljs.core.nth.call(null,vec__40308,(2),null);
...
return (function (p__40312){
var vec__40313 = p__40312;
var munged_name = cljs.core.nth.call(null,vec__40313,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40313,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40313,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40311_SHARP_){
return (obj[cljs.core.first.call(null,p1__40311_SHARP_)]);
});})(name,sorted_matches,vec__40313,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1518288639969
