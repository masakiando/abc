...
var reader = (function (){var or__30102__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__30102__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__30102__auto__)){
return or__30102__auto__;
} else {
return (128);
...
var line = cljs.core.get.call(null,map__42055__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__42055__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e42054){var _e = e42054;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___42057 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___42057)){
var seen_errors_42058 = temp__5455__auto___42057;
if(cljs.core.truth_(seen_errors_42058.has(self))){
} else {
seen_errors_42058.add(self);

var temp__5457__auto___42059 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___42059)){
var sense_42060 = temp__5457__auto___42059;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42060)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1518288644131
